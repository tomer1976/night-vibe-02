...
## Description
Implements the 'Venue Gender Distribution Analytics' capability according to Section 14 – Venue Statistics and Analytics, preserving Night Vibe core invariants (venue-gated interaction, server-side authority, and deterministic conflict handling).

## Scope
- In scope: domain behavior, validation rules, state transitions, and API/event handling required for 'Venue Gender Distribution Analytics'.
