...
## Description
Implements the 'Haversine Distance Calculation' capability according to Section 7 – Venue Discovery and Nearby Venue Retrieval, preserving Night Vibe core invariants (venue-gated interaction, server-side authority, and deterministic conflict handling).

## Scope
- In scope: domain behavior, validation rules, state transitions, and API/event handling required for 'Haversine Distance Calculation'.
