...
## Description
Implements the 'Duplicate Venue Detection' capability according to Section 6 – Venue Model, Venue Lifecycle, and Venue Management, preserving Night Vibe core invariants (venue-gated interaction, server-side authority, and deterministic conflict handling).

## Scope
- In scope: domain behavior, validation rules, state transitions, and API/event handling required for 'Duplicate Venue Detection'.
