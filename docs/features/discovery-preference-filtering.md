...
## Description
Implements the 'Discovery Preference Filtering' capability according to Section 9 – User Discovery and Potential Match Generation, preserving Night Vibe core invariants (venue-gated interaction, server-side authority, and deterministic conflict handling).

## Scope
- In scope: domain behavior, validation rules, state transitions, and API/event handling required for 'Discovery Preference Filtering'.
