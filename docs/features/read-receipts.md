...
## Description
Implements the 'Read Receipts' capability according to Section 11 – Real-Time Chat System for Matched Users, preserving Night Vibe core invariants (venue-gated interaction, server-side authority, and deterministic conflict handling).

## Scope
- In scope: domain behavior, validation rules, state transitions, and API/event handling required for 'Read Receipts'.
