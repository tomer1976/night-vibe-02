...
## Description
Implements the 'Single Active Venue Session Enforcement' capability according to Section 8 – Venue Check-In System and Presence Validation, preserving Night Vibe core invariants (venue-gated interaction, server-side authority, and deterministic conflict handling).

## Scope
- In scope: domain behavior, validation rules, state transitions, and API/event handling required for 'Single Active Venue Session Enforcement'.
