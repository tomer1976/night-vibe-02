...
## Description
Implements the 'Moderation Queue Management' capability according to Section 12 – Blocking, Reporting, and User Safety Enforcement, preserving Night Vibe core invariants (venue-gated interaction, server-side authority, and deterministic conflict handling).

## Scope
- In scope: domain behavior, validation rules, state transitions, and API/event handling required for 'Moderation Queue Management'.
